...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        body =
            body == null ? wrapAndCustomizeProblem(ex, (NativeWebRequest) request) : body;
    ...
    private String extractTitleForResponseStatus(Throwable err, int statusCode) {
        ...
        return specialStatus == null ? HttpStatus.valueOf(statusCode).getReasonPhrase()
    ...
    private ResponseStatus resolveResponseStatus(final Throwable type) {
        ...
        return candidate == null && type.getCause() != null ? resolveResponseStatus(type.getCause())
            : candidate;
    }
    ...
    public Optional<ProblemDetailWithCause> buildCause(final Throwable throwable,
        NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.",
            "com.",
            "io.", "de.", "com.pfe");
    }
}

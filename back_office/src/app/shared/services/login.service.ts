...
export class LoginService {
  ...
  public login(userLogin): Observable<TokenResponse> {
    return this.globalService.call(
      RequestType.POST,
      this.globalService.url.base + 'api/v1/oauth/token',
      userLogin,
      );
  }

  public rneLogin(loginRequest : Observable<TokenResponse>){
    return this.globalService.call(RequestType.POST, this.globalService.url.base + 'api/v1/oauth/rne-token',
      loginRequest,
    );
  }
  ...
  public signup(user): Observable<any> {
    return this.globalService.call(
      RequestType.POST,
      this.globalService.url.base + 'api/v1/oauth/register',
      user,
    );
  }
  ...
  public preSignup(user): Observable<any> {
    return this.globalService.call(
        RequestType.POST,
        this.globalService.url.base + 'api/v1/oauth/pre-register',
        user,
    );
  }
  ...
  public sendResetPassword(email: string, username: string): Observable<any>{
    return this.globalService.call(
      RequestType.POST,
      this.globalService.BASE_USER_MANAGEMENT_URL + 'api/v1/open-api/reset-password-request',
      {email, username}
    );
  }
  ...
  public verifyNationalId(nationalId: any):Observable<any> {
    const newUrl = this.globalService.BASE_USER_MANAGEMENT_URL+ this.globalService.API_V1_URL +`open-api/nationalid-verif`+ '?nationalId=' + nationalId;
    return this.globalService.call(
        RequestType.GET,
        newUrl
    );
  ...
  public refreshToken(): Observable<string> {
    ...
    return this.globalService.call(
        RequestType.POST,
        this.globalService.url.base + 'api/v1/oauth/refresh',
        {refreshToken}
    ).pipe(tap(response => {
  ...
  public getAllByNationalId(nationalId:string): Observable<User[]> {
    return this.globalService.call(RequestType.GET, this.globalService.BASE_USER_MANAGEMENT_URL+ this.globalService.API_V1_URL + 'open-api/by-national-id'+ '?nationalId=' + nationalId);
  }
  public checkInternalUsername(nationalId:string): Observable<boolean> {
     const request = { nationalId: nationalId };

    return this.globalService.call(RequestType.POST, this.globalService.BASE_USER_MANAGEMENT_URL+ this.globalService.API_V1_URL + 'open-api/check-username-prefix', request);
  }
  public checkUsernameMatch(nationalId: string, username: string): Observable<boolean> {
    const request = { nationalId, username };

    return this.globalService.call(RequestType.POST, this.globalService.BASE_USER_MANAGEMENT_URL+ this.globalService.API_V1_URL + 'open-api/check-username-match', request);
  }
  public checkExternalUsername(nationalId:string): Observable<boolean> {
    const request = { nationalId: nationalId };

    return this.globalService.call(RequestType.POST, this.globalService.BASE_USER_MANAGEMENT_URL+ this.globalService.API_V1_URL + 'open-api/check-username-ext-prefix', request);
  }
}

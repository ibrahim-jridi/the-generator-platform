...
class CustomSubmitButtonComponent extends ButtonCustomComponent {
  ...
  static get builderInfo() {
    return {
      ...
      icon: 'folder-o',
      weight: 50,
      schema: CustomSubmitButtonComponent.schema()
    };
  }
  ...
  public static override schema(...extend) {
    return ButtonCustomComponent.schema({
      ...
      custom: 'try {\n' +
          ...
          '        instance.emit(\'customSubmit\', \'modal\', \'Operation successful\', \'Success\');\n' +
          '        formInstance.submit();\n' +
          '      } else {\n' +
...
export default CustomSubmitButtonComponent;
Components.addComponent('customSubmit', CustomSubmitButtonComponent);

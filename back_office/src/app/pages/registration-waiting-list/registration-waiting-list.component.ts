...
@Component({
  selector: 'app-registration-waiting-list',
  templateUrl: './registration-waiting-list.component.html',
  styleUrl: './registration-waiting-list.component.scss'
})
export class RegistrationWaitingListComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    ...
    const processKey: string = 'REGISTRATION_WAITING_LIST';

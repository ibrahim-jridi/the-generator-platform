...
@Component({
  selector: 'app-subsidiary-pct',
  templateUrl: './subsidiary-pct.component.html',
  styleUrl: './subsidiary-pct.component.scss'
})
export class SubsidiaryPctComponent {
  constructor(
  ...
  ngOnInit() {
    const processKey: string = 'FILIALE_PCT_MODEL_LTS';

...
@Component({
  selector: 'app-create-pct',
  templateUrl: './create-pct.component.html',
  styleUrl: './create-pct.component.scss'
})
export class CreatePctComponent implements OnInit{
  constructor(
  ...
  ngOnInit() {
    const processKey: string = 'CREATE_PCT_MODEL_LTS';

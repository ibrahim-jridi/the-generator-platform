...
@Component({
  ...
  templateUrl: './rse-engagement-management.component.html',
  styleUrls: ['./rse-engagement-management.component.scss']
})
export class RseEngagementManagementComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    const processKey: string = 'RSE_ENGAGEMENT';

...
@Component({
  selector: 'app-industrie-humain',
  templateUrl: './industrie-humain.component.html',
  styleUrl: './industrie-humain.component.scss'
})
export class IndustrieHumainComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    ...
    const processKey: string = 'INDUSTRIE_HUMAIN_MODEL_LTS';

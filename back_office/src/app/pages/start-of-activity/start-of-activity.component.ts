...
@Component({
  ...
  templateUrl: './start-of-activity.component.html',
  styleUrls: ['./start-of-activity.component.scss']
})
export class StartOfActivityComponent implements OnInit {
  constructor(
  ...
  ngOnInit() {
    const processKey: string = 'START_ACTIVITY';

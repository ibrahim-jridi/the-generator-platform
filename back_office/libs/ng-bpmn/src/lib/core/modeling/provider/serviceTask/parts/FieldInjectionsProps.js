...
import ParameterProps from './FieldInjectionProps';


export default function FieldInjectionsProps({ element, injector }) {
...
function addFactory({ element, bpmnFactory, commandStack }) {
  return function(event) {
    ...
    const newParameter = createElement('camunda:Field', {

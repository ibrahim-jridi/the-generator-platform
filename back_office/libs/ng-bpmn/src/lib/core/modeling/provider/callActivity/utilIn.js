...
export function getParametersExtension(element) {
  ...
  return getExtension(businessObject, 'camunda:InputMapping');
}
...
export function getExtension(element, type) {
  ...
  return (
    element.extensionElements.values.filter(function (e) {
...
export function createParameters(properties, parent, bpmnFactory) {
  return createElement('camunda:InputMapping', properties, parent, bpmnFactory);
}

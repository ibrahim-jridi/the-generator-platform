...
public class FolderAsserts {
    ...
    public static void assertFolderUpdatableFieldsEquals(Folder expected, Folder actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getRecurrence()).as("check recurrence").isEqualTo(actual.getRecurrence()))
    ...
    public static void assertFolderUpdatableRelationshipsEquals(Folder expected, Folder actual) {
        assertThat(expected)
            ...
            .satisfies(
                e -> assertThat(e.getParent()).as("check parent").isEqualTo(actual.getParent()));
    }
}

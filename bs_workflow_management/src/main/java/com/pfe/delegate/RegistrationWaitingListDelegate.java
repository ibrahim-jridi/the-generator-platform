...
@Component
public class RegistrationWaitingListDelegate implements JavaDelegate {
    private final WaitingListService waitingListService;
    private static final Logger log = LoggerFactory.getLogger(RegistrationWaitingListDelegate.class);

    public RegistrationWaitingListDelegate(WaitingListService waitingListService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        this.waitingListService.createWaitingList(waitingListDTO);

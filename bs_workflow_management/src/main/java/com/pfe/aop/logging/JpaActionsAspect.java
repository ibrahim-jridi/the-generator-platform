...
public class JpaActionsAspect {
    ...
    @Before(value = "execution(* com.pfe.interceptors.CustomPreDeleteEventListener.onPreDelete())")
    ...
    @AfterThrowing(
        pointcut = "execution(* com.pfe.services.servicesImplementation.TraceActionServiceImpl.*(..))",
        throwing = "ex"
    )

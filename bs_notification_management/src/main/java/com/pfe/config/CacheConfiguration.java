...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, Event.class.getName());
            createCache(cm, Notification.class.getName());
            createCache(cm, Notification.class.getName() + ".fk_notification__frequency");
            createCache(cm, NotificationDestination.class.getName() + ".fk_notification_destination__notification");
            createCache(cm, Frequency.class.getName());
            createCache(cm, Days.class.getName() + ".fk_days__frequency");
            createCache(cm, NotificationPushed.class.getName() + ".fk_notification_pushed__notification");
            createCache(cm, EventNotification.class.getName());
